...
class GrayingItem(MyItem):
    def __init__(self, parent=None):
        super(GrayingItem, self).__init__(' Grayscale ', parent=parent)
...
class FilterItem(MyItem):
    ...
    def __init__(self, parent=None):
        super().__init__('smoothing', parent=parent)
        self._ksize = 3
...
class MorphItem(MyItem):
    def __init__(self, parent=None):
        super().__init__(' morphology ', parent=parent)
        self._ksize = 3
...
class GradItem(MyItem):
    ...
    def __init__(self, parent=None):
        super().__init__('image gradient', parent=parent)
...
class ThresholdItem(MyItem):
    def __init__(self, parent=None):
        super().__init__('Thresholding', parent=parent)
        self._thresh = 127
        self._maxval = 255
...
class EdgeItem(MyItem):
    def __init__(self, parent=None):
        super(EdgeItem, self).__init__('edge detection', parent=parent)
        self._thresh1 = 20
        self._thresh2 = 100
...
class ContourItem(MyItem):
    def __init__(self, parent=None):
        super(ContourItem, self).__init__('conterdetection', parent=parent)
...
class EqualizeItem(MyItem):
    def __init__(self, parent=None):
        super().__init__(' equalization ', parent=parent)
        self._blue = True
        self._green = True
        self._red = True
...
class HoughLineItem(MyItem):
    def __init__(self, parent=None):
        super(HoughLineItem, self).__init__('Straightlinedetection', parent=parent)
        self._rho = 1
...
class LightItem(MyItem):
    def __init__(self, parent=None):
        super(LightItem, self).__init__('Dimming', parent=parent)
        self._alpha = 1
        self._beta = 0
...
class GammaItem(MyItem):
    def __init__(self, parent=None):
        super(GammaItem, self).__init__('gamacorrection', parent=parent)
        self._gamma = 1
